%% --------------------------------------------------------------
%% reliable_digraph.erl -
%%
%% Copyright (c) 2014 Alejandro M. Ramallo. All rights reserved.
...
%% -----------------------------------------------------------------------------
%% @doc Returns a new instance of a reliable_digraph of type cyclic.
%% @end
%% -----------------------------------------------------------------------------
-spec new() -> t().
...
info(G) ->
    ...
    Cyclicity = case G#reliable_digraph.cyclic of
        true  -> cyclic;
        false -> acyclic
    end,
    Memory =
...
-spec view(
    ...
    Value::{vertex(), vertex(), label()})-> boolean())) -> reliable_digraph_view().
...
%% @private
increment_version(G) ->
    G#reliable_digraph{vers=G#reliable_digraph.vers + 1}.
